...
//            printf("CAN SEND BACK to NODE[%d]\n", boardConfig.canNodeId );
        ...
        case 0x26: // getKP
        {
            auto* b = (unsigned char*) &boardConfig.dce_kp;
            for (int i = 0; i < 4; i++)
                _data[i] = *(b + i);
            _data[4] = 0;
            _data[5] = 0;
        ...
        case 0x27: // getKi
        {
            auto* b = (unsigned char*) &boardConfig.dce_ki;
            for (int i = 0; i < 4; i++)
                _data[i] = *(b + i);
            _data[4] = 0;
            _data[5] = 0;
        ...
        case 0x28: // getKd
        {
            auto* b = (unsigned char*) &boardConfig.dce_kd;
            for (int i = 0; i < 4; i++)
                _data[i] = *(b + i);
            _data[4] = 0;
            _data[5] = 0;
        ...
        case 0x29: // getKd
        {
            auto* b = (unsigned char*) &boardConfig.dce_kv;
            for (int i = 0; i < 4; i++)
                _data[i] = *(b + i);
            _data[4] = 0;
            _data[5] = 0;
